...
* [`src/gabby_rf/`](src/gabby_rf/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/gabby_rf/core.cljs): contains the SPA entry point, `init`
* [`test/gabby_rf/`](test/gabby_rf/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `gabby-rf` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/gabby_rf/config.cljs) defaults to `true` in
...
```clj
(ns gabby-rf.example
  (:require [gabby-rf.config :as config])
...
After successfully running *npm run release* you can deploy to *staging
